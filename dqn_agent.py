...
class Agent():
    ...
    buffer_size=int(1e5), batch_size=64, gamma=0.99, tau=1e-3, lr=5.e-4, update_every=4):
    ...
    def learn(self, experiences, gamma):
        ...
        #Q_targets_next = torch.gather(self.qnetwork_target(next_states).detach(),1, best_action)
